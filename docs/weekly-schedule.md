...
| :------------------------------------------------------------------------------------------- | :---------------------------------------- | :----------------------------------------------------------------------------------------------------------------- |
| **Create a Debian Linux VM in VirtualBox:**                                                  | - [Welcome to OPS245](/slides/w1-l1.pptx) | [Lab 1: Installing Debian Linux with VirtualBox](/A-Labs/lab1.md)                                                  |
| - Install Debian (Full Install) in the VirtualBox application (create customized partitions) | - [Installing Linux](/slides/w1-l2.pptx)  | **WARNING: If working on your own device, install VirtualBox from the website, do not use the MyApps application** |
| - Obtain System Information                                                                  |                                           | **Do not use any other virtualization software!**                                                                  |
